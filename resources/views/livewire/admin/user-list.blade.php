<div class="max-w-7xl mx-auto">
    ...
    <div x-data="{ open: false }" class="mb-6">
        <button
            @click="open = !open" wire:click="resetForm" class="inline-flex items-center rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-indigo-700">
