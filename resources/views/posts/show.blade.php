<x-app-layout>
    <div class="max-w-4xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden mt-10">
        ...
        @if(auth()->user()->hasRole('admin') || auth()->user()->hasRole('moderator') && $post->status === 'pending')
    ...
    @include('components.scripts.confirm-delete')

    @include('components.scripts.map-script')
